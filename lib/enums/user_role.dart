enum UserRole {
  ...
  // Check if current role can access editor features
  bool get canAccessEditor => level >= UserRole.editor.level;
  ...
  bool get canModerateContent => level >= UserRole.editor.level;
