...
class TopicStylingHelper {
  ...
  static const Map<String, Color> _topicColors = {
    ...
    'national-international': Color(
      0xFF45B7D1,
    ), // Blue - National/International
  ...
  static Color getTopicColor(Topic topic) {
    ...
    if (key.contains('nationalinternational'))
      return _topicColors['national-international']!;
    ...
    if (key.contains('mobileselectronics'))
      return _topicColors['mobiles-other-electronics']!;
  ...
  static String getTopicEmoji(Topic topic) {
    ...
    if (key.contains('nationalinternational'))
      return _topicEmojis['national-international']!;
    ...
    if (key.contains('mobileselectronics'))
      return _topicEmojis['mobiles-other-electronics']!;
  ...
  static ({String emoji, Color color}) getTopicStyling(Topic topic) {
    return (emoji: getTopicEmoji(topic), color: getTopicColor(topic));
  }
}
